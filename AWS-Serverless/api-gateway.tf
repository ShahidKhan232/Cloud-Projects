...
resource "aws_api_gateway_deployment" "student_api_deployment" {
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      aws_api_gateway_method.options_method_get.id,
      aws_api_gateway_integration.options_integration_get.id,
      aws_api_gateway_method_response.options_response_200_get.id,
      aws_api_gateway_integration_response.options_integration_response_get.id
    ]))
  }
